...
function Effect:set_dynamic_type(dynamic_type)
...
function Pet:install_ability_by_id(id, index)
    ...
    elseif id == AbilityID.ARFUS_6 then
        ...
        ability.effect_list = {
            [1] = {Effect.new_damage(TypeID.BEAST, 54), Effect.new_damage(TypeID.BEAST, 54),
                   Effect.new_damage(TypeID.BEAST, 54),
                   Effect.new(TypeID.BEAST, EffectType.AURA, 100, AuraID.SHATTER_DEFENSE, TargetType.ENEMY, 0, true)},
            [2] = {Effect.new_damage(TypeID.BEAST, 90), Effect.new_damage(TypeID.BEAST, 90),
                   Effect.new_damage(TypeID.BEAST, 90),
                   Effect.new(TypeID.BEAST, EffectType.AURA, 100, AuraID.SHATTER_DEFENSE, TargetType.ENEMY, 0, true)},
            [3] = {Effect.new_damage(TypeID.BEAST, 126), Effect.new_damage(TypeID.BEAST, 126),
    ...
    elseif id == AbilityID.ROCK_BARRAGE then
        ...
        ability.effect_list = {
            [1] = {Effect.new_damage(TypeID.ELEMENTAL, (20 + self.power) * 0.4, 50),
                   ...
                   Effect.new_damage(TypeID.ELEMENTAL, (20 + self.power) * 0.4, 50),
                   Effect.new_damage(TypeID.ELEMENTAL, (20 + self.power) * 0.4, 50),
                   Effect.new(TypeID.ELEMENTAL, EffectType.AURA, 999, AuraID.ROCK_BARRAGE, TargetType.ENEMY,
                IGNORE_BIT_ALL)}
        }
    ...
    elseif id == AbilityID.MINEFIELD then
        ...
        ability.effect_list[1] = {Effect.new(TypeID.MECHANICAL, EffectType.AURA, 999, AuraID.MINEFIELD,
    ...
    elseif id == AbilityID.ALPHA_STRIKE then
        ...
        ability.effect_list[1] = {Effect.new_damage(TypeID.FLYING, (20 + self.power) * 0.75, 95),
                                  Effect.new(TypeID.FLYING, EffectType.DAMAGE, 100, (20 + self.power) * 0.5,
    ...
    elseif id == AbilityID.NOCTURNAL_STRIKE then
        ...
        ability.effect_list[1] = {Effect.new_damage(TypeID.FLYING, (20 + self.power) * 2, 50):set_dynamic_type(
            EffectDynamicType.NOCTURNAL_STRIKE)}
    elseif id == AbilityID.BURN then
        ability = Ability.new(id, TypeID.ELEMENTAL, 0, 0)
