...
function StateFrame:Create()
    ...
    local area = CreateFrame("ScrollFrame", "MyAddonLogScroll", stateFrame, "UIPanelScrollFrameTemplate")
    area:SetPoint("TOPLEFT", 10, -30)
    area:SetPoint("BOTTOMRIGHT", -30, 30)
   local stateText = area:CreateFontString(nil, "OVERLAY", "GameFontHighlight")
